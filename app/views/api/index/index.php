	...
	<div id="main">
		<div class="demo">
			<form class="jqtransform" action="#" method="post">
				...
				<p>
					<label>用户名：</label><input type="text" value="<?php echo $name;?>" />
				</p>
				<p>
					<label>密码：</label><input type="password" />
				</p>
				<p>
					<label>性别：</label><input type="radio" name="sex" /> <label
						style="width: auto">男</label> <input type="radio" name="sex" /> <label
						style="width: auto">女</label>
				</p>

				<p>
					<label>短信订阅：</label><input type="checkbox" /> <label>开通短信订阅功能</label>
				</p>
				<p>
					<label>备注：</label>
